...
// Fallback downloadable resources
const FALLBACK_RESOURCES: Resource[] = [
  {
    id: '1',
    title: 'Panduan Hak-Hak Penyandang Disabilitas di Indonesia',
    description: 'Panduan lengkap mengenai UU No. 8 Tahun 2016 tentang Penyandang Disabilitas dan implementasinya.',
    category: 'hukum',
    type: 'pdf',
    file_url: '/downloads/panduan-hak-disabilitas.pdf',
    file_size: 2500000,
    file_type: 'pdf',
    read_time: '30 mnt',
    is_published: true,
  ...
  {
    id: '2',
    title: 'Panduan Aksesibilitas Digital untuk Website',
    description: 'Cara membuat website yang aksesibel sesuai standar WCAG 2.1 untuk pengguna dengan berbagai disabilitas.',
    category: 'aksesibilitas',
    type: 'pdf',
    file_url: '/downloads/aksesibilitas-digital.pdf',
    file_size: 1800000,
    file_type: 'pdf',
    read_time: '25 mnt',
    is_published: true,
  ...
  {
    id: '3',
    title: 'Terapi Okupasi: Panduan untuk Orang Tua',
    description: 'Panduan praktis untuk orang tua dalam mendampingi anak dengan kebutuhan terapi okupasi di rumah.',
    category: 'kesehatan',
    type: 'ebook',
    file_url: '/downloads/terapi-okupasi-ortu.pdf',
    file_size: 3200000,
    file_type: 'pdf',
    read_time: '45 mnt',
    is_published: true,
  ...
  {
    id: '4',
    title: 'Mencari Pekerjaan Inklusif: Tips & Strategi',
    description: 'Panduan lengkap mencari pekerjaan bagi penyandang disabilitas, termasuk hak-hak dan tips wawancara.',
    category: 'pekerjaan',
    type: 'pdf',
    file_url: '/downloads/tips-kerja-inklusif.pdf',
    file_size: 1500000,
    file_type: 'pdf',
    read_time: '20 mnt',
    is_published: true,
  ...
  {
    id: '5',
    title: 'Video: Pengenalan Bahasa Isyarat Indonesia (BISINDO)',
    description: 'Tutorial video dasar Bahasa Isyarat Indonesia untuk pemula.',
    category: 'tutorial',
    type: 'video',
  ...
  {
    id: '6',
    title: 'Infografis: Jenis-Jenis Disabilitas',
    description: 'Infografis edukatif mengenai berbagai jenis disabilitas dan cara berinteraksi yang tepat.',
    category: 'panduan',
    type: 'infographic',
    file_url: '/downloads/infografis-jenis-disabilitas.png',
    file_size: 500000,
    file_type: 'png',
    read_time: '5 mnt',
    is_published: true,
  ...
  {
    id: '7',
    title: 'Panduan Pendidikan Inklusif untuk Guru',
    description: 'Panduan komprehensif untuk guru dalam menerapkan pendidikan inklusif di kelas.',
    category: 'pendidikan',
    type: 'pdf',
    file_url: '/downloads/pendidikan-inklusif-guru.pdf',
    file_size: 4500000,
    file_type: 'pdf',
    read_time: '60 mnt',
    is_published: true,
  ...
  {
    id: '8',
    title: 'Template Rencana Pembelajaran Individual (RPI)',
    description: 'Template siap pakai untuk membuat Rencana Pembelajaran Individual bagi siswa berkebutuhan khusus.',
    category: 'pendidikan',
    type: 'template',
    file_url: '/downloads/template-rpi.docx',
    file_size: 250000,
    file_type: 'docx',
    read_time: '10 mnt',
    is_published: true,
  ...
  {
    id: '9',
    title: 'Membangun Komunitas Support yang Efektif',
    description: 'Panduan membentuk dan mengelola grup support untuk keluarga penyandang disabilitas.',
    category: 'komunitas',
    type: 'article',
    content_url: '/artikel/membangun-komunitas-support',
    read_time: '12 mnt',
    is_published: true,
    is_downloadable: false,
    download_count: 650,
